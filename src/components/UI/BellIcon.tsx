import "@/components/UI/Bellicon.css";
...
export default function BellIcon({ count, color = "#9ca3af" }: Props) {
  return (
    <div className="bell">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        />
        {count > 0 && (
          <circle cx="17.5" cy="4.5" r="3.5" fill="#F30000" stroke="white" strokeWidth="2" />
        )}
      </svg>
